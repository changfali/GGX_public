...
out_path = r'out/test_run/test19/'
code_path = './'
...
imgs_path = r'test_data\textures\texture_only\brick_rough_vh2pddg\renders/'
texture_gd = get_texture(r'test_data\textures\texture_only\brick_rough_vh2pddg\tex/')[H//2-size//2:H//2-size//2+size, W//2-size//2:W//2-size//2+size]
